        ...
        <header className="sticky top-0 z-50 w-full bg-[#FAF9F5]/80 backdrop-blur-lg border-b border-[#2F3E33]/5">
            <div className="container flex h-20 max-w-screen-2xl items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <WhatsAppConsultationLink className="hidden md:inline-flex h-9 items-center justify-center gap-2 rounded-full bg-green px-4 text-sm font-semibold text-white hover:bg-[#003835] transition-colors">
